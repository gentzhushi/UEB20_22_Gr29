const cars = [
    { brand: 'Toyota', model: 'Corolla', year: 2018, price: 15000 },
    { brand: 'Honda', model: 'Civic', year: 2019, price: 18000 },
    { brand: 'BMW', model: 'X3', year: 2020, price: 40000 },
    { brand: 'Mercedes', model: 'E-Class', year: 2017, price: 35000 },
...
// Kod JavaScript (ndryshimi i vogël në displayCars)
function displayCars(carsToShow) {
    carList.innerHTML = '';
